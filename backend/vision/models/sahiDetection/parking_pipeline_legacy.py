"""
LEGACY PIPELINE — AREA-BASED OCCUPANCY (DEPRECATED)

This file implements an IoA + center-based parking occupancy model.
It is retained for experimentation and comparison only.
